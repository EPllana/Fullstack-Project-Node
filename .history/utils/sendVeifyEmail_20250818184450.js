...
export const sendVerifyEmail = async (email, userId) => {
  ...
  const mailOptions = {
    ...
    html: `Click Here To Verify Your Email: <a href="${verifyUrl}" style="background-color: #4CAF50; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">
    Verify Here
  </a>`
  };
