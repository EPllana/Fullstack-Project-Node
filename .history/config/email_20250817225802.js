...
export const sendVerificationEmail = async (email, name, verificationToken) => {
  console.log(`Sending email to: ${email}`);  // Ensure that the email is correct
  console.log(`Verification Token: ${verificationToken}`);  // Check the token value
  ...
  try {
    const info = await transporter.sendMail({
      ...
      to: email,  // Email should be passed here
