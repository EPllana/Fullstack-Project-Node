...
export const isAuthenticated = async (req ,res ,next)=>{
    ...
    const decode  = jwt.verify(token, secretKey)//split string e ndan ne array 0 item i par 1 item i dyt tokeni decode user id edhe roli  e kem bo req.user mju aksesu kti useri
    req.user=decode 
    next();
     }catch(error){
