...
import { sendVerificationEmail }  from "../../utils/sed";
...
export const verifyEmail = async (req, res) => {
  try {
    const { token } = req.query;  // Kjo është mënyra që përdorim për të marrë token-in
    ...
    user.verificationToken = null; // Pas verifikimit, mund ta fshish token-in
    await user.save();
