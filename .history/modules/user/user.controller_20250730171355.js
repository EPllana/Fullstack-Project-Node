...
export const updateUser = async (req, res)=>{
  ...
  if(email) user.email = email;
  if(phoneNumber) user.phoneNumber = phoneNumber;
 // ktu ja jepum veq e bojm update me kejt dhe tek paraemter req.user._id edhe ka n fund if role kta e hjekum krjt mos meeeditu rolin e vetes ky mos mepat mundsi 
