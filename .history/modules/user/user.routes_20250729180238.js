...
//router.put("/")
//router.delete("/")
router.get("/", isAuthenticated , authorize([]), getAllUsers)// next e perdorim se isauthenticated esht nmes per at arsye authorize ebojm array mju jep qasje adminit dhe moderatorit
