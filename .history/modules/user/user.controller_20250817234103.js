...
export const verifyEmail = async (req, res) => {
  try {
    ...
    if (!user) {
      console.log("No user found for token:", token);  // Log the token to check if it's matching
    ...
    try {
      ...
      console.log("Decoded Token:", decoded);  // Log decoded token for expiration check
    ...
    // Update the user as verified and remove the verification token
