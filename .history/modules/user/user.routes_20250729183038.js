...
router.delete("/:id", isAuthenticated,authorize,(['admin', 'moderator']),isAuthenticated, deleteUser);// edhe ktu muedmi mebo dekativate me me fhsi veten authorize melan veq user 
