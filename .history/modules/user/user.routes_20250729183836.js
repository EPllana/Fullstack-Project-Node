...
import { createUser,getAllUsers,getOneUser,updateUser,deleteUser,changePassword,deleteMe } from "../user/user.controller.js";///addReview// e shtojm me import 
...
router.put("/:id",isAuthenticated,authorize,(['admin', 'moderator']), updateUser) // mundemi me shtu update me me bo update veq veten selojm kurgju prej frontit req.user._id veq vettit mebo update 
...
router.delete("/deleteMe", isAuthenticated,authorize,(['admin', 'moderator']),isAuthenticated, deleteUser);
