...
//router.put("/")
//router.delete("/")
router.get("/",  getAllUsers)// next e perdorim se isauthenticated esht nmes per at arsye authorize ebojm array mju jep qasje adminit dhe moderatorit
...
router.put("/:id",isAuthenticated,authorize(['admin', 'moderator','user']), updateUser) // mundemi me shtu update me me bo update veq veten selojm kurgju prej frontit req.user._id veq vettit mebo update  TEK UPDATE ME duhet mebo 
