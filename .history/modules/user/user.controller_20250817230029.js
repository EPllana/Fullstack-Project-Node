...
import { sendVerificationEmail } from '../../config/email.js'; // Ensure email utility is imported
...
export const createUser = async (req, res) => {
  try {
    ...
    // Hash the password using bcrypt with saltRounds=10 for security
    ...
    // Generate a verification token with user ID and expiration time of 1 hour
    ...
    // Send the verification email to the user with the token
