...
{$goup:{_id:null,totalRevenue:{$sum:"$totalPrice"} }}//ktu me mbledh totalprice
  ])//aggregate kthen array posht e bojm nje check qe me kthy ne 0 mos me fail 
const totalRevenue = revenueResults.length > 0 ? revenueResults[0].totalRevenue:0;  // nse e om a e madhe se - ekthy ket 
  }catch(error){
